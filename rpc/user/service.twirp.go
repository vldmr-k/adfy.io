...
func (c *userServiceProtobufClient) Me(ctx context.Context, in *Empty) (*MeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "adfy.io.rpc.user")
	ctx = ctxsetters.WithServiceName(ctx, "UserService")
	ctx = ctxsetters.WithMethodName(ctx, "Me")
	caller := c.callMe
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *Empty) (*MeResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *userServiceProtobufClient) callMe(ctx context.Context, in *Empty) (*MeResponse, error) {
	out := new(MeResponse)
...
func (c *userServiceJSONClient) Me(ctx context.Context, in *Empty) (*MeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "adfy.io.rpc.user")
	ctx = ctxsetters.WithServiceName(ctx, "UserService")
	ctx = ctxsetters.WithMethodName(ctx, "Me")
	caller := c.callMe
...
func (c *userServiceJSONClient) callMe(ctx context.Context, in *Empty) (*MeResponse, error) {
	out := new(MeResponse)
...
func (s *userServiceServer) serveMeJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *Empty) (*MeResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*Empty)
					if !ok {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
