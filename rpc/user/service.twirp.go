...
type UserService interface {
	...
	Me(context.Context, *google_protobuf5.Empty) (*MeResponse, error)
}
...
func (c *userServiceProtobufClient) SignIn(ctx context.Context, in *SignInRequest) (*SignInResponse, error) {
	...
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *SignInRequest) (*SignInResponse, error) {
			...
			if resp != nil {
				typedResp, ok := resp.(*SignInResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*SignInResponse) when calling interceptor")
				}
...
func (c *userServiceProtobufClient) callSignIn(ctx context.Context, in *SignInRequest) (*SignInResponse, error) {
...
func (c *userServiceProtobufClient) Me(ctx context.Context, in *google_protobuf5.Empty) (*MeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "adfy.io.rpc.user")
	ctx = ctxsetters.WithServiceName(ctx, "UserService")
	ctx = ctxsetters.WithMethodName(ctx, "Me")
	caller := c.callMe
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *google_protobuf5.Empty) (*MeResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *userServiceProtobufClient) callMe(ctx context.Context, in *google_protobuf5.Empty) (*MeResponse, error) {
	out := new(MeResponse)
...
func (c *userServiceJSONClient) callSignIn(ctx context.Context, in *SignInRequest) (*SignInResponse, error) {
	out := new(SignInResponse)
...
func (c *userServiceJSONClient) Me(ctx context.Context, in *google_protobuf5.Empty) (*MeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "adfy.io.rpc.user")
	ctx = ctxsetters.WithServiceName(ctx, "UserService")
	ctx = ctxsetters.WithMethodName(ctx, "Me")
	caller := c.callMe
...
func (c *userServiceJSONClient) callMe(ctx context.Context, in *google_protobuf5.Empty) (*MeResponse, error) {
	out := new(MeResponse)
...
func (s *userServiceServer) serveSignInJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	handler := s.UserService.SignIn
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *SignInRequest) (*SignInResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.UserService.SignIn(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*SignInResponse)
...
func (s *userServiceServer) serveMeJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *google_protobuf5.Empty) (*MeResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*google_protobuf5.Empty)
					if !ok {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
